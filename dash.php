...
<body>
    ...
    <main class="page landing-page">
        <section class="clean-block clean-hero" style="background-image:url(&quot;assets/img/tech/image4.jpg&quot;);color:rgba(9, 162, 255, 0.85);height:451px;">
            <div class="text">
                <h2>Bienvenido, Nombre.</h2>
                <p>Aqui puedes encontrar la solucion de todas tus necesidades de MDV. Tienes una pregunta?<br></p><button class="btn btn-outline-light btn-lg" type="button">Habla con el Webmaster</button></div>
        </section>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card clean-card text-center"><img class="card-img-top w-100 d-block" src="assets/img/avatars/avatar1.jpg">
                            <div class="card-body info">
                                ...
                                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p><button class="btn btn-outline-primary btn-sm" type="button">Entrar</button></div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
